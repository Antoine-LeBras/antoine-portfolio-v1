!(function (e, t) {
  ...
  var r = function e(t) {
    ...
    function h(e, t) {
      for (var n = Date.now(); $.length > 0 && !(n - $[0].time <= 100); )
        $.shift();
      $.push({
        x: e,
        y: t,
    ...
    function y(e) {
      return 5e-6 * Math.pow(e, 2) + 1e-4 * e + 0.55;
    }
      ...
      if (Z) {
        ...
        if (Math.abs(O) > K || Math.abs(G) > K || !e.inBounds) {
          if (P) {
            ...
            0 !== e.x && ((H = e.x > 0 ? S : D), (O = 0)),
              0 !== e.y && ((J = e.y > 0 ? R : U), (G = 0));
          d(), s(L);
        } else Z = !1;
      }
    }
    ...
    var S,
      ...
      $ = [];
    !(function () {
      if (!(M = "string" == typeof M ? document.querySelector(M) : M))
        throw new Error("IMPETUS: source not found.");
      if (!g) throw new Error("IMPETUS: update function not defined.");
      Y && (Y[0] && (H = Y[0]), Y[1] && (J = Y[1]), d()),
        A && ((S = A[0]), (D = A[1])),
        F && ((R = F[0]), (U = F[1])),
        M.addEventListener("touchstart", f),
        M.addEventListener("mousedown", f);
    })(),
      (this.destroy = function () {
        return (
          M.removeEventListener("touchstart", f),
